  ...
  return (
    <main className={styles.main}>
      <div className={styles.content}>
        <div className={styles.tag}>v1.0 · Free &amp; Open Source</div>

        <h1 className={styles.title}>
          Read markdown.<br />
          <span className={styles.dim}>Nothing else.</span>
        </h1>

        <p className={styles.lede}>
          A clean, distraction-free markdown viewer.
          Opens <code>.md</code> files directly from your operating system.
        </p>
        ...
        <div className={styles.actions}>
          ...
          <a href="https://github.com/yug-space/markdown-viewer" target="_blank" rel="noreferrer" className={styles.btnSecondary}>
        ...
        <div className={styles.platforms}>
          Also available on <a href="#">Windows</a> and <a href="#">Linux</a>
        </div>
      </div>
    </main>
  );
